...
public class BusinessMessage {
    ...
    public static class Appointment{
        ...
        public static final String APPOINTMENT_LISTED = "Appointment listed successfully";
    ...
    public static class Clinic{
        ...
        public static final String CLINIC_LISTED = "Clinic listed successfully";
    ...
    public static class Department{
        ...
        public static final String DEPARTMENT_LISTED = "Department listed successfully";
    ...
    public static class Document{
        ...
        public static final String DOCUMENT_LISTED = "Document listed successfully";
    ...
    public static class DocumentType{
        ...
        public static final String DOCUMENT_TYPE_LISTED = "Document type listed successfully";
    ...
    public static class Employee{
        ...
        public static final String EMPLOYEE_LISTED = "Employee listed successfully";
    ...
    public static class HasRole{
        ...
        public static final String HAS_ROLE_LISTED = "Has role listed successfully";
    ...
    public static class InDepartment{
        ...
        public static final String IN_DEPARTMENT_LISTED = "In department listed successfully";
    ...
    public static class Patient{
        ...
        public static final String PATIENT_LISTED = "Patient listed successfully";
    ...
    public static class PatientCase{
        ...
        public static final String PATIENT_CASE_LISTED = "Patient case listed successfully";
    ...
    public static class Schedule{
        ...
        public static final String SCHEDULE_LISTED = "Schedule listed successfully";
    ...
    public static class StatusHistory{
        ...
        public static final String STATUS_HISTORY_LISTED = "Status history listed successfully";
